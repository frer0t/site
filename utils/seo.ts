...
const description = `hi, i'm ${mydetails.name}, i started software engineering in 2023, with andela. i'm currently software engineer at kigali software. before that, i was Backend engineer at eden care medical. i ❤️ lowercase, side projects and monkeytype.`;
